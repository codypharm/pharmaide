...
- Buffered-message processing endpoint: aggregate unprocessed patient messages and feed the existing patient-reply/safety flow from an internal worker seam.
