  ...
  return (
    ...
    >
      ...
      <div className="flex items-center justify-between text-[10px] font-medium text-slate-400">
        <span>{item.first_medication_name ?? "No medication name"}</span>
    ...
    <div className="p-8 border-b border-slate-100 flex items-center justify-between shrink-0">
      <div className="flex flex-col">
        ...
        <p className="text-sm text-slate-500">
          MRN: {item.patient.mrn} | Primary medication: {item.first_medication_name ?? "Not listed"}
        </p>
      </div>
...
function InteractionLog({
  ...
  return (
    <aside className="w-[420px] border-l border-slate-100 flex flex-col shrink-0 overflow-hidden">
      ...
      <div className="p-4 border-t border-slate-100">
        ...
        <div className="flex gap-2">
          <input
            ...
            className="flex-1 pl-4 pr-4 py-2 bg-slate-50 border border-slate-200 rounded-xl text-xs focus:ring-2 focus:ring-blue-100 transition-all"
          />
          <button
            type="button"
